                          ...
                          {group.statements.map((s) => {
                            ...
                            return (
                              <tr key={s.id} onClick={() => router.push(`/admin/bank-reconciliation/${s.id}`)}
                                ...
                                <td className="px-6 py-2.5 text-body-md text-right tabular-nums text-gray-900">{formatRM(s.closing_balance)}</td>
                                <td className="px-6 py-2.5 text-body-md text-center text-gray-700">{s.total}</td>
                                <td className="px-6 py-2.5">
                                  <div className="flex items-center gap-2">
