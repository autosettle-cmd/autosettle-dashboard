...
function balanceColor(val: number) {
  if (val > 0) return 'text-[var(--reject-red)]';   // firm owes supplier
  if (val < 0) return 'text-[var(--match-green)]'; // supplier owes firm
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto paper-texture">
          <div className="ledger-binding p-8 pl-14 max-w-5xl">
            ...
            {/* Back link */}
            <Link href="/admin/suppliers" className="inline-flex items-center gap-1.5 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors mb-4">
