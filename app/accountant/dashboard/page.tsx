...
function StatCard({ label, value, amount, color, href }: {
  ...
  const card = (
    <div
      className={`bg-white px-4 py-3 transition-all duration-150 card-popped ${href ? 'cursor-pointer hover:shadow-[3px_3px_6px_rgba(0,0,0,0.08)] active:translate-y-[2px]' : ''}`}
    >
