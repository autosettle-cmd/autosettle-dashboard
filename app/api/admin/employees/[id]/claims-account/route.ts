...
export async function GET(
  ...
  // Approved claims = credit (firm owes employee more)
  ...
  // Payments to employee = debit (reduces what firm owes)
  ...
  entries.sort((a, b) => {
    ...
    // Claims before payments on same date
