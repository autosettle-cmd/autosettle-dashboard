                        ...
                        <button
                          onClick={async () => {
                            ...
                            try {
                              ...
                              const file = new File([blob], `${(previewInvoice.invoice_number || 'voucher').replace(/[^a-zA-Z0-9-]/g, '_')}.pdf`, { type: 'application/pdf' });
                              ...
                              setAttachWarnings(['Failed to generate and attach PDF']);
                            } finally {
                              setAttachingFile(false);
                            }
                          }}
